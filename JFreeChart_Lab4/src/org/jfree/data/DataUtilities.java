...
public abstract class DataUtilities {
    ...
    public static double calculateColumnTotal(Values2D data, int column) {
        ...
        for (int r = 0; r < rowCount; r++) {
          ...
          //Removed Redundant Loop to increase Mutation Coverage that resulted in No Coverage
...
//            }
    ...
    public static double calculateColumnTotal(Values2D data, int column,
       ...
       if (validRows == null) {
           throw new IllegalArgumentException("Valid rows array cannot be null");
       }
...
//            }
    ...
    public static double calculateRowTotal(Values2D data, int row, int[] validCols) {
        ...
        // Check if colCount is non-negative
        if (colCount >= 0) {
